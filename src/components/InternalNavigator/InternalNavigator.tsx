...
// function Internal(props: NavigatorProps & { screenProps: ScreenProps }) {

// 	const { navigator, screenProps } = props;
// 	const { type, routes } = navigator;

//   // If routes is a thunk, resolve it
// 	const resolvedRoutes = resolveThunk<RouteConfigWithResolveSubRoutes[]>(routes as any, screenProps.BB);
...
// 	return (
//     <NavigatorComponent {...navigator} screenProps={screenProps} routes={resolvedRoutes} />
// 	);
// }

const InternalNavigatorComponent = (props: InternalNavigatorProps & { screenProps: ScreenProps }) => {
...
withScreenProps(withRouter(InternalNavigatorComponent as any)) as React.ComponentType<InternalNavigatorProps>;